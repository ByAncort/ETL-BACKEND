package com.necronet.integrationms.aspect;
...
public class ExecutionLoggingAspect {
    ...
    @Around("execution(* com.necronet.integrationms.service.*.*(..))")
    public Object logServiceExecution(ProceedingJoinPoint joinPoint) throws Throwable {
        return logExecution(joinPoint, null);
    }

    @Around("execution(* com.necronet.integrationms.controller.*.*(..))")
    public Object logControllerExecution(ProceedingJoinPoint joinPoint) throws Throwable {
        return logExecution(joinPoint, "integrationId");
    }

    private Object logExecution(ProceedingJoinPoint joinPoint, String idParamHint) throws Throwable {
