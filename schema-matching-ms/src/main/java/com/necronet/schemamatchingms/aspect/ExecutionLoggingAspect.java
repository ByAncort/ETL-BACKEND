package com.necronet.schemamatchingms.aspect;
...
import com.necronet.schemamatchingms.repository.ExecutionLogRepository;
...
public class ExecutionLoggingAspect {
    ...
    @Around("execution(* com.necronet.schemamatchingms.service.*.*(..))")
    public Object logServiceExecution(ProceedingJoinPoint joinPoint) throws Throwable {
        return logExecution(joinPoint);
    }

    @Around("execution(* com.necronet.schemamatchingms.controller.*.*(..))")
