package com.metacontrol.etlconfig.aspect;
...
import com.metacontrol.etlconfig.repository.ExecutionLogRepository;
...
public class ExecutionLoggingAspect {
    ...
    @Around("execution(* com.metacontrol.etlconfig.service.*.*(..))")
    public Object logServiceExecution(ProceedingJoinPoint joinPoint) throws Throwable {
        return logExecution(joinPoint);
    }

    @Around("execution(* com.metacontrol.etlconfig.controller.*.*(..))")
